...
顏色抽查現按 DDS 的實際寬高計算像素面積。2048 的布／木／金屬／標籤分別抽查 77,608／33,856／15,360／512 點，平均誤差 0.0079／0.0059／0.0044／0.0063，第 90 百分位 0.0222／0.0132／0.0097／0.0130，全數低於原門檻。兩個解析度納入的面不同，這些數字不是相同樣本的畫質排名；仍需按 [回家驗收](HOME-VALIDATION.md) 比較實際布紋、法線與碰撞。ZIP 只含 Data 檔案，操作說明、來源署名與報告留在批次目錄。
